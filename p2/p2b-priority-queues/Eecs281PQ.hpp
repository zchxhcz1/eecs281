...
class Eecs281PQ {
public:
    // Description: Compiler default implementation of ~ and =
    virtual ~Eecs281PQ() = default;
    virtual Eecs281PQ &operator=(const Eecs281PQ &) = default;
    virtual Eecs281PQ &operator=(Eecs281PQ &&) noexcept = default;
...
protected:
    // Description: Compiler default implementation of constructors
    Eecs281PQ() = default;
    Eecs281PQ(const Eecs281PQ &) = default;
    Eecs281PQ(Eecs281PQ &&) noexcept = default;
    ...
    COMP_FUNCTOR compare;  // NOLINT: comparator stored in base class
};  // Eecs281PQ
